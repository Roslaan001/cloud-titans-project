...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'ssl': {
                'ca': 'C:/Users/OKKKKK/Downloads/cloud-titans-main-project/eu-west-1-bundle.pem'
            }
        }
    }
}
...
AWS_PROFILE_PICTURE_STORAGE_BUCKET_NAME = env('AWS_PROFILE_PICTURE_STORAGE_BUCKET_NAME')
...
PROFILE_PICTURE_STORAGE = ProfilePictureStorage()
